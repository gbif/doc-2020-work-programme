...
* *France*: Help for French translations: GBIF.org, workshop materials. Co-organised with Norway and the NSG chairs, invitation of the project leader of a Balkan project and few observers of Balkan and eastern countries to the EU nodes meeting in Oslo, Norway (may 2019).
