...
* *Canadensys*: Canadensys publishes on its IPT data, such as specimens consulted for taxonomic revisions and georeferenced observations used in other research, using doi’s that are included in peer reviewed publications.
...
* *Canadensys*: We will continue to use doi to link datasets and to keep track with the publications using data published on Canadensys.
